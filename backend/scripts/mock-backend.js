 ...
 * Provides all API endpoints without needing a real database
 */
...
app.post('/api/auth/login', (req, res) => {
  ...
  mockData.refreshToken = refreshToken;
...
app.post('/api/upload', authenticateToken, (req, res) => {
  ...
  const imageUrl = `https://via.placeholder.com/${300}x${200}?text=Uploaded+Image`;
