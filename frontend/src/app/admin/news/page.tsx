          ...
          <div>
            ...
            <div className="md:hidden divide-y divide-zinc-800/80">
              {processedNews.map((item) => {
                ...
                return (
                  <div key={item.id} className="p-4 space-y-3 bg-zinc-950/60 hover:bg-zinc-900/40 transition">
                    {/* Title */}
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2 text-[11px]">
                      <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 bg-zinc-800 border border-zinc-700/60 text-zinc-300 rounded font-mono">
                    ...
                    <div className="pt-2 border-t border-zinc-900 flex items-center justify-between gap-2">
                      ...
                      >
                        <span>{isBreaking ? '⚡ Breaking ON' : '⚡ Breaking OFF'}</span>
                      </button>

                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => router.push(`/admin/news/edit/${item.id}`)}
                          className="px-3 py-1.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 rounded-lg text-xs font-medium flex items-center gap-1 transition cursor-pointer"
                        >
                        ...
                        {showConfirm === item.id ? (
                          <div className="flex items-center gap-1">
                            <button
                              ...
                              className="px-2.5 py-1.5 bg-red-600 hover:bg-red-500 text-white rounded-lg text-xs font-bold cursor-pointer"
                            >
                              Yes
                            </button>
                            <button
                              onClick={() => setShowConfirm(null)}
                              className="px-2 py-1.5 bg-zinc-800 text-zinc-400 rounded-lg text-xs cursor-pointer"
                            >
                              No
                            </button>
                          </div>
                          ...
                          <button
                            ...
                            className="p-2 bg-zinc-900 hover:bg-red-950/50 text-zinc-400 hover:text-red-400 border border-zinc-800 rounded-lg text-xs transition cursor-pointer"
                        ...
                        <td className="py-3 px-4 text-right">
                          {showConfirm === item.id ? (
                            <div className="flex items-center justify-end gap-1.5">
                              ...
                              <button
                                onClick={() => setShowConfirm(null)}
                                className="px-2 py-0.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded text-[10px] cursor-pointer"
                              >
                                No
                              </button>
                            </div>
