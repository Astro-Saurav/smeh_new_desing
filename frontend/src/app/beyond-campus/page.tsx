...
export default function Page() {
  ...
  useEffect(() => {
    getNewsByCategory("Beyond Campus", 20).then(data => { setStories(data); setLoading(false); });
  }, []);
      ...
      <main className="container mx-auto px-4 md:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            <h3 className="text-xs font-black uppercase tracking-[0.2em] border-b-2 border-zinc-900 pb-3 mb-6">More in Beyond Campus</h3>
