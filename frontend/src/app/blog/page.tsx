...
export default function Page() {
  ...
  useEffect(() => {
    getNewsByCategory("Blog", 20).then(data => { setStories(data); setLoading(false); });
  }, []);
      ...
      <main className="container mx-auto px-4 md:px-8 py-8">
        <div className="border-b-4 border-zinc-900 mb-10 pb-4">
          <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase">
            MRT <span className="text-primary italic">Blog</span>
          </h1>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5">
            <h3 className="text-xs font-black uppercase tracking-[0.2em] border-b-2 border-zinc-900 pb-3 mb-6">More in Blog</h3>
