...
export default function CreateGalleryAlbumPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto font-sans antialiased text-zinc-200 pb-16">
      ...
      <form onSubmit={handleSubmit} className="bg-gradient-to-b from-zinc-900/70 to-zinc-950/70 border border-zinc-800/80 rounded-xl p-4 sm:p-6 md:p-8 shadow-sm space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-zinc-950/80 border border-zinc-800 hover:border-zinc-700 rounded-lg text-white text-xs placeholder-zinc-600 focus:outline-none focus:border-red-500/80 transition"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleInputChange}
            placeholder="Brief album description..."
            rows={2}
            className="w-full px-3.5 py-2.5 bg-zinc-950/80 border border-zinc-800 hover:border-zinc-700 rounded-lg text-white text-xs placeholder-zinc-600 focus:outline-none focus:border-red-500/80 transition resize-none"
          />
        </div>
        ...
        <div>
          ...
          />
          {preview && (
            <img src={preview} alt="Cover Preview" className="w-full h-36 object-cover rounded-lg mt-2 border border-zinc-800" />
          )}
        </div>
        ...
        <div className="bg-zinc-950/60 border border-zinc-800/80 rounded-xl p-4 sm:p-5 space-y-3">
          ...
          {albumImages.length > 0 ? (
            ...
            <div className="border border-dashed border-zinc-800 rounded-xl p-6 text-center text-zinc-500 text-xs font-normal">
        ...
        <div className="pt-2">
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 sm:py-3.5 px-4 bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-500 hover:to-rose-500 disabled:opacity-50 text-white font-bold text-xs sm:text-sm rounded-xl transition shadow-md cursor-pointer"
          >
